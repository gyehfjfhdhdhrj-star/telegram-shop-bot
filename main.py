...
အပေါ်ကနေရာမှာ အကောင့်မှာပါတဲ့ skinအတိုချုပ် ရောထည့်ပေးပါ

အကောင့်ရှာတဲ့နေရာ ကွက်တိကျမှာ အကောင့်ကို ထုတ်ပြတာမဟုတ်ဘဲ အနီးစပ်ဆုံးအကောင့်တွေကို ပြပေးပါ နီးစပ်နေတဲ့ အကောင့်က နစ်ကောင့် ရှိတယ်ဆိုရင် တစ်ကောင့်အရင် ပြပြီး နောက်အကောင့်ဆက်ကြည့်ရန် ဆိုပြီး menuနဲ့ ပြပေးပါ နောက်အကောင်သို့ပြန်ကြည့်ရန် ဆိုပြီးလဲ ထည့်‌ပေးပါ

အကောင့်ကြည့်မယ်ဆိုတဲ့ menuမှာလဲ အတူတူ ဘဲ
ACC-001 ကနေပြီးတော့ စပြီး အစဥ်လိုက် ပြပေးပါ နောက်အကောင့်ဆက်ကြည့်ရန် ဆိုပြီး menuနဲ့ ပြပေးပါ နောက်အကောင်သို့ပြန်ကြည့်ရန် ဆိုပြီးလဲ ထည့်‌ပေးပါ

code ကို update လုပ်ပြီးသား v4 ပြန်ရေးပေးပါ ဒီတစ်ခါ codeရေးရင် အရင်က အကောင့်တင်မယ် ဆိုတာတင်ထားတဲ့ အကောင့်ဟောင်းတွေ ပျောက်မသွားပါစေနဲ့ အဲ့အကောင့်တွေကို အမြဲသိမ်းထားပါ adminဖျတ်မှ data baseထဲ ဖျတ်ပါ

ငါပေးထားတဲ့ codingထဲကိုမှ အခုငါပေးထားတဲ့ အချက်အလက်တွေကို updateလုပ်ပေးးပါ ငါပေးထားတဲ့ codingထဲက ဟာတွေကို လဲ တခုမှ ဖြုတ်မပြစ်ပါနဲ့ updateဘဲလုပ်ပေးပါ
...
set_state(ADMIN_ID,{"flow":"seller_publish_price","request_id"})
...
အခုငါပေးထားတဲ့ အချက်အလက်တွေကို updateလုပ်ပေးးပါ ငါပေးထားတဲ့ codingထဲက ဟာတွေကို လဲ တခုမှ ဖြုတ်မပြစ်ပါနဲ့ updateဘဲလုပ်ပေးပါ အရင်botပုံစံ လုံးဝ မပြောင်းဘဲငါလုပ်ခိုင်းတာကိုဘဲ updateသာလုပ်ပေးပါ အရမ်းအရေးကြီးတယ်


main (2).py
Python
မြန်မာစာမပျောက်ဘဲ Premium UI  ကို ငါအရင် codeတွေကို မထိဘဲ updateလုပ်ပေးပါ  

ရပါတယ်။ ဒီတစ်ခါ မူရင်း Logic / Database / Callback / မြန်မာစာ flow တွေကို မထိဘဲ UI Helper ပိုင်းကိုပဲ Premium ပုံစံပြောင်းမယ်။

မင်းရဲ့ main (2).py ထဲမှာ # UI HELPERS အောက်က def main_menu(user_id): ကနေ def admin_keyboard(): အဆုံးအထိပဲ အောက်က code နဲ့ အစားထိုးပါ။ မူရင်း set_state() ကနေစပြီး မဖျက်ပါနဲ့။ မူရင်း code မှာ အဲဒီ state functions တွေက ဒီနေရာမှာ ဆက်ရှိနေပါတယ်။ 
...
def main_menu(user_id):
    ...
    if user_id == ADMIN_ID:
        markup.add(
            InlineKeyboardButton(
                "👑  ADMIN • အကောင့်အသစ်တင်ရန်",
                callback_data="admin_add"
            ),
            InlineKeyboardButton(
                "📊  ADMIN • လက်ကျန်အကောင့်များ",
...
def buy_menu_keyboard():
    ...
    markup.add(
        InlineKeyboardButton(
            "🌈  အကုန်လုံးကြည့်မယ်",
            callback_data="buy_all_skin"
        ),
        InlineKeyboardButton(
            "✨  Collector",
            callback_data="skin_Collector"
        ),
        InlineKeyboardButton(
            "🔥  Epic",
            callback_data="skin_Epic"
        ),
        InlineKeyboardButton(
            "💎  Legend",
            callback_data="skin_Legend"
        ),
    )

    markup.add(
        InlineKeyboardButton(
            "⌨️  ကိုယ်လိုချင်တဲ့ Skin နာမည် ရိုက်မယ်",
            callback_data="skin_custom"
        )
    )
...
def budget_keyboard():
    ...
    markup.add(
        InlineKeyboardButton(
            "💵  50,000 MMK",
            callback_data="budget_50000"
        ),
        InlineKeyboardButton(
            "💵  100,000 MMK",
            callback_data="budget_100000"
        ),
        InlineKeyboardButton(
            "💵  200,000 MMK",
            callback_data="budget_200000"
        ),
        InlineKeyboardButton(
            "💵  300,000 MMK",
            callback_data="budget_300000"
        ),
    )

    markup.add(
        InlineKeyboardButton(
            "⌨️  Budget ကို ကိုယ်တိုင်ရိုက်မယ်",
...
def admin_keyboard():
    ...
    return markup
အရေးကြီးတယ်
ဒီ code ထည့်တဲ့အခါ အောက်ကဟာတွေကို လုံးဝ မထည့်ပါနဲ့ —

def set_state(...)
def get_state(...)
def clear_state(...)
def set_search_skin(...)
def set_search_budget(...)
အဲဒါတွေက မင်းရဲ့ မူရင်း code ဖြစ်ပြီး UI မဟုတ်ပါဘူး။ 


ပြီးတော့ format_account() နဲ့ send_account_photos() ကိုလည်း မပြောင်းပါနဲ့။ အဲဒီ function တွေက account ပုံ၊ ဝယ်မယ် button နဲ့ account data ပြသတဲ့ logic ပါ။ 


ဒီ patch ရဲ့အကျိုးက button layout ကိုပဲ Premium ပိုင်းပြောင်းတာ ဖြစ်ပြီး callback_data တွေကို မူရင်းအတိုင်းထားထားလို့ ရှိပြီးသား function တွေနဲ့ ချိတ်ဆက်မှု မပြောင်းပါဘူး။


မင်းနဲ့ငါပြောခဲ့တဲ့ chatတစ်ခုလုံးထဲကမှ ငါလိုချင်တဲ့ ပုံစံတွေကို ပြောခဲ့တယ် ငါပြောခဲ့တာတွေအကုန်လုံးအကုန်လုံးကို ပြန်လေ့လာပြီး ပြီးပြည့်စုံတဲ့ coding ရေ‌းပေးပါ ဟိုးအစကတည်းကနေ ခုချိန်ထိ ငါလိုချင်ပုံစံနော် သေချာလေ့လာပြီး လုပ်ပေးပါ

ဟုတ်တယ်။ ဒီတစ်ခါတော့ မင်းနဲ့ အရင်ပြောခဲ့တဲ့ requirement တွေ + မင်းပေးခဲ့တဲ့ code version တွေကို ပြန်လေ့လာပြီး v3 ကို အခြေခံထားတဲ့ Complete Final Version အဖြစ် ပြင်ဆင်ထားတယ်။

အဓိက ထည့်ထားတာတွေက—

🇲🇲 မြန်မာစာ မပျောက်အောင် UI/Flow တွေကို မြန်မာလိုထားထားတယ်။

💎 Premium-style Account Card

🆔 ACC-001 → ACC-002 → ... အစဉ်လိုက် Browse

⬅️ အရင် Account / နောက် Account ➡️

🔎 Skin search ကို exact-only မဟုတ်ဘဲ nearest match အရင်ပြ

💰 Budget filter

🔎 Search result ကို တစ်ကြိမ်မှာ Account တစ်ခုတည်း ပြပြီး Previous/Next ရှိ

📸 Admin/Seller ပို့တဲ့ပုံတွေကို မူရင်းအစဉ်မပြောင်း

📸 Account တစ်ခုကို ပုံ 15 ပုံအထိ

🧹 Account ပြောင်းတဲ့အခါ အရင် Account ရဲ့ photo/text တွေကို ရှင်း

👤 Seller flow — Error / Binding / Moonton Mail / Estimated Price

👑 Seller Request / Approve / Reject

💰 Seller payout price နဲ့ Marketplace listing price သီးခြား
...
🛡️ Database migration — ရှိပြီးသား DB ကို reset/drop မလုပ်

🔢 ရှိပြီးသား ACC-025 ရှိရင် နောက်တစ်ခု ACC-026 ကနေ ဆက်

❌ Hidden / Sold / Reserved လုပ်တာက database ထဲက Account ကို မဖျက်

🐛 အရင်က Bot မပြန်တော့စေတဲ့ recursive cleanup_callback_message() bug ကို ဖြုတ်ထား

🐛 browse_prev ကို generic browse_ handler က ဖမ်းသွားတဲ့ callback bug ကိုလည်း ပြင်ထားတယ်။

အဲဒီအချက်တွေဟာ မင်းပေးခဲ့တဲ့ versions ထဲမှာ တကယ်ပါလာခဲ့တဲ့ requirements/logic တွေကို အခြေခံထားတာပါ။ ဥပမာ မင်းရဲ့ code မှာ persistent SQLite database နဲ့ migration structure ရှိပြီးသားဖြစ်ပြီး၊ Seller flow မှာ Binding/Moonton/Estimated Price အဆင့်တွေပါခဲ့တယ်။ 


Final coding file ကို ဒီမှာပေးထားတယ် —

📥 telegram_bot_premium_final.py ကို Copy/Download လုပ်ရန်

ပြီးတော့ syntax ကို py_compile နဲ့ စစ်ပြီး Python syntax error မရှိတာ အတည်ပြုထားတယ်။

အရေးကြီးဆုံး: ဒီ file က မင်းရဲ့ အရင် DB ကို DROP TABLE / reset မလုပ်ဘူး။ Existing account data မပျောက်အောင် migration ပုံစံနဲ့ ဆက်သုံးဖို့လုပ်ထားတယ်။ မင်းရဲ့ အရင် code မှာလည်း SQLite account data ကို permanent သိမ်းတဲ့ structure ရှိပြီးသားပါ။ 


ဒါပေမယ့် ဒီ environment မှာ pyTelegramBotAPI/telebot package မရှိလို့ Bot ကို ဒီနေရာကနေ Telegram နဲ့ live run test မလုပ်နိုင်ခဲ့ဘူး။ Syntax-level testတော့ အောင်မြင်ပါတယ်။


telegram_bot_premium_final.py
Code
...
ရပါပြီ။ ဒီတစ်ခါ အရင်ရှိပြီးသား Function တွေကို မဖျက်ဘဲ မင်းပြောထားတဲ့ အချက် ၃ ခုကိုပဲ Update လုပ်ထားပါတယ်။

ပြင်ထားတာ
စာတွေကို မဖျောက်/မဖျက်တော့ပါဘူး
အရင်က Account တစ်ခုကြည့်ပြီး နောက်တစ်ခုကြည့်တဲ့အခါ အဟောင်း message တွေ delete လုပ်တဲ့အပိုင်းကို ပိတ်ထားပါတယ်။ အရင် Account တွေ၊ စာတွေက chat ထဲမှာ ဆက်ရှိနေပါမယ်။

Admin → အကောင့်တင်မယ် မှာ
ခေါင်းစဉ် → Skin အချက်အလက် → ပုံများ → ဈေး ဆိုပြီး Skin အချက်အလက်ထည့်တဲ့အဆင့် ထည့်ထားပါတယ်။ Database မှာလည်း skins field ရှိပြီး Account ပြတဲ့နေရာမှာ Skin အချက်အလက်ကို ပြနိုင်တဲ့အတိုင်း ရှိပြီးသားပါ။ 


Search Navigation ကို
🔎 ရှာဖွေထားတဲ့ အကောင့်တွေကို ကြည့်ရန်
လို့ လူနားလည်လွယ်တဲ့ မြန်မာစာ ပြောင်းထားပါတယ်။

Python syntax စစ်ပြီး အောင်မြင်ပါတယ် — code error မရှိပါဘူး။

Updated Code
📥 telegram_bot_premium_final.py ကို Download လုပ်ရန်

အရေးကြီး: ဒီ version မှာ မင်းမပြင်ခိုင်းထားတဲ့ feature တွေကို ရည်ရွယ်ချက်ရှိရှိ မဖျက်ထားပါဘူး။ မူရင်း code ရဲ့ Account, Seller, Discount, Admin Manage, Analysis, Tips, Search စတဲ့ flow တွေကို ဆက်ထားပါတယ်။ 
